...
<p>A honlapot a github szerkesztőprogrammal lehetne kódolni, valamelyik startbootstrap séma átalakításával. A favikont a gyökérkönyvtárban helyezem el favicon.ico néven, az index.html fájlba átmásolva tudom majd megjeleníteni <a class="https://hu.wikipedia.org/wiki/Favicon" href="https://hu.wikipedia.org/wiki/Favicon">link rel="shortcut icon" type="<link rel="shortcut icon" type="image/png" href="/path/image.png" />"/</a> kódolás segítségével.</p>
